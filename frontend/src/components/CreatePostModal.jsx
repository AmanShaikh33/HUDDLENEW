...
const CreatePostModal = ({ onClose }) => {
  ...
  // Resolve profile picture formats
  const profilePic =
        ...
        <div className="w-96 bg-white p-6 rounded-3xl shadow-2xl relative">
          ...
          <div className="mb-4 relative">
            <input
              ...
              className="w-full py-3 px-5 rounded-full border-2 border-yellow-400 
                         focus:outline-none focus:border-yellow-500 bg-white 
                         placeholder-gray-500 text-gray-700 text-center"
            />
          ...
          <div className="flex justify-between space-x-4">
            ...
            <button
              onClick={handlePost}
              disabled={loading}
              className={`flex-1 py-3 rounded-full bg-purple-600 text-white 
                          font-semibold shadow-md transition-colors ${
                            loading ? 'bg-purple-400' : 'hover:bg-purple-700'
                          }`}
            >
